...
public class ItemRedbull extends Item
{
    ...
    public void initModel() {
        final ModelResourceLocation full = new ModelResourceLocation(getRegistryName() + "_full", "inventory");
        final ModelResourceLocation empty = new ModelResourceLocation(getRegistryName() + "_empty", "inventory");

        ModelBakery.registerItemVariants(this, full, empty);
